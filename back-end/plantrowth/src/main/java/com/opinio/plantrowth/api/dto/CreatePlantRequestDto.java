...
public class CreatePlantRequestDto {
    ...
    public CreatePlantRequestDto(String plant_species, String plant_name, LocalDate plant_birth, Integer plant_exp, String fileName, Integer water_supply, Integer alarm_cycle) {
